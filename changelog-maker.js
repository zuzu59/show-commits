...
const myRequest = new Request('https://api.github.com/repos/TacticsCH/changelog-maker/commits', 
  {
    method: 'GET',
...
fetch(myRequest)
  ...
  .then(function (data) {
   ...
   //console.log(data);
    //let newBody = '';
    let newBody = '<h1>changelog maker 1223</h1>';
    newBody += '<a href="https://github.com/TacticsCH/changelog-maker" >https://github.com/TacticsCH/changelog-maker</a>';
    let authors = [];
    data.forEach((item, i) => {

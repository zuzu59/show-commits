...
const myRequest = new Request('https://api.github.com/repos/zuzu59/esphome_home5/commits', 
  {
    method: 'GET',
...
fetch(myRequest)
  ...
  .then(function (data) {
   ...
   //console.log(data);
    //let newBody = '';
    let newBody = '<h1>esphome home5 1216</h1>';
    newBody += '<a href="https://github.com/zuzu59/esphome_home5" >https://github.com/zuzu59/esphome_home5</a>';
    let authors = [];
    data.forEach((item, i) => {

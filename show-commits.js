...
const myRequest = new Request('https://api.github.com/repos/zuzu59/show-commits/commits', 
  {
    method: 'GET',
...
fetch(myRequest)
  ...
  .then(function (data) {
   ...
   //console.log(data);
    //let newBody = '';
    let newBody = '<h1>show commits 1226</h1>';
    newBody += '<a href="https://github.com/zuzu59/show-commits" >https://github.com/zuzu59/show-commits</a>';
    let authors = [];
    data.forEach((item, i) => {
